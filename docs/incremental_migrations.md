...
python scripts/migration_workflow.py test --revision ***REMOVED_SECRET***
...
python scripts/migration_workflow.py validate --file alembic/versions/***REMOVED_SECRET***_add_field.py
