...
python .github/scripts/migration_workflow.py test --revision ***REMOVED_SECRET***
...
python .github/scripts/migration_workflow.py validate --file alembic/versions/***REMOVED_SECRET***_add_field.py
...
```python
# alembic/versions/2024_01_15_1430-***REMOVED_SECRET***_add_common_name_to_species.py
def upgrade() -> None:
...
│   └── 2024_01_15_1430-***REMOVED_SECRET***_add_field.py
